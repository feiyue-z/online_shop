...
public class GlobalLoggingFilter implements GlobalFilter, Ordered {
    ...
    private final LinkedBlockingQueue<GatewayRequest> requests = new LinkedBlockingQueue<>();
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        requests.add(
            new GatewayRequest()
                .setIpAddress(request.getRemoteAddress().getAddress().getHostAddress())
